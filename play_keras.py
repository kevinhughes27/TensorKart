...
from train_keras import creation_model
import numpy as np
...
if __name__ == '__main__':
    ...
    # env = gym.make('Mario-Kart-Sherbet-Land-v0')
    # env = gym.make('Mario-Kart-Kalimari-Desert-v0')
    # env = gym.make('Mario-Kart-Choco-Mountain-v0')
    # env = gym.make('Mario-Kart-Wario-Stadium-v0')
    # env = gym.make('Mario-Kart-Bowsers-Castle-v0')  # just for fun
    obs = env.reset()
    env.render()
    print('env ready!')
